...
import com.youyu.cotenant.security.CustomCmsAuthenticationProvider;
...
public class JWTLoginCmsFilter extends AbstractAuthenticationProcessingFilter {

    @Autowired
    private RedisUtils redisUtils;

    @Autowired
    private CustomCmsAuthenticationProvider customCmsAuthenticationProvider;

    public JWTLoginCmsFilter(String url, AuthenticationManager authenticationManager) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
        ...
        //返回一个验证令牌
        return customCmsAuthenticationProvider.authenticate(new UsernamePasswordAuthenticationToken(
                        user.getUsername(),
                        user.getPassword(),
                        authSet
                )
